                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item pt-1 mr-2">
                            <a class="nav-link" href="{{ route('order.index') }}" data-toggle="tooltip"
                                data-placement="top" title="Order">
                        ...
                        <li class="nav-item pt-1 mr-2">
                            <a class="nav-link" href="{{route('message.index')}}" data-toggle="tooltip"
                                data-placement="top" title="Messages">
