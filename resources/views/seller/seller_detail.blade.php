                    ...
                    <div class="col-8">
                            ...
                            <div class="col-10">
                                <div class="progress">
                                    <div class="progress-bar" role="progressbar"
                                        style="width: {{$star5/$starAll*100}}%;" aria-valuenow="{{$star5/$starAll*100}}"
                                        aria-valuemin="0" aria-valuemax="100">{{$star5}}</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-10">
                                <div class="progress">
                                    <div class="progress-bar" role="progressbar"
                                        style="width: {{$star4/$starAll*100}}%;" aria-valuenow="{{$star4/$starAll*100}}"
                                        aria-valuemin="0" aria-valuemax="100">{{$star4}}</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-10">
                                <div class="progress">
                                    <div class="progress-bar" role="progressbar"
                                        style="width: {{$star3/$starAll*100}}%;" aria-valuenow="{{$star3/$starAll*100}}"
                                        aria-valuemin="0" aria-valuemax="100">{{$star3}}</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-10">
                                <div class="progress">
                                    <div class="progress-bar" role="progressbar"
                                        style="width: {{$star2/$starAll*100}}%;" aria-valuenow="{{$star2/$starAll*100}}"
                                        aria-valuemin="0" aria-valuemax="100">{{$star2}}</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-10">
                                <div class="progress">
                                    <div class="progress-bar" role="progressbar"
                                        style="width: {{$star1/$starAll*100}}%;" aria-valuenow="{{$star1/$starAll*100}}"
                                        aria-valuemin="0" aria-valuemax="100">{{$star1}}</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-3">
                                <div class="view overlay rounded z-depth-1 gallery-item round-border">
                                    <img src="{{ asset('/storage/'.$package->profile_picture)}}" class="img-fluid">
