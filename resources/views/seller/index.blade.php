    ...
    <div class="row">
        ...
        <div class="col-3 d-flex p-2">
            ...
            <div class="card mb-4" style="height: 450px">
                    <a href="{{route('seller.detail',$seller->id)}}"><img class="card-img-top" style="width: 100%; height:210px" src="{{ asset('/storage/'.$seller->profile_picture) }}" alt="Card image cap"></a>
                    ...
                    <div class="card-footer d-flex justify-content-center">
                        ...
                        <div class="">
                            ...
                            <p class="d-inline font-weight-bold" style="font-size: 18px;">/ 5.0 <i class="text-warning fa fa-star" style="font-size: 1.5rem;"></i></p>
                        </div>
                    </div>
            </div>
        </div>
